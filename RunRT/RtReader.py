...
class RtReader:
    ...
    def Plotables(self):
        ...
        if self.radiovalue:
            ...
            fkeys = [k for k in self.menucheck.keys() if
                     self.menucheck[k].get() and not k.startswith(" ")]
        return fkeys
    ...
    def RT_01_setup(self):
        self.rtkeys = ["WL", "FFEW", "TOPDN", "TOPUP", "TOPDIR", "BOTDN",
                       "BOTUP", "BOTDIR", "TOPFLUX", "BOTFLUX", "ABSORPTION"]
        self.rtunits = {" Wavenumber": "", " EffectiveTemp": "",
                        " Transmitted": "",
                        "TOPDN": "$W/m^2/\mu m$", "TOPUP": "$W/m^2/\mu m$",
                        "TOPDIR": "$W/m^2/\mu m$",
                        "BOTDN": "$W/m^2/\mu m$", "BOTUP": "$W/m^2/\mu m$",
                        "BOTDIR": "$W/m^2/\mu m$",
                        "TOPFLUX": "$W/m^2/\mu m$", "BOTFLUX": "$W/m^2/\mu m$",
                        "ABSORPTION": "$W/m^2/\mu m$"}
        self.intensity = False
    ...
    def RT_01(self, out, label, ydict):
        ...
        fout.append(
            [fout[5][k] - fout[6][k] for k in range(0, nwl)])  # botflx 8
        fout.append(
            [fout[2][k] - fout[3][k] for k in range(0, nwl)])  # topflx 9
    ...
    def RT_02_setup(self):
        self.rtkeys = ["WL", "H2O", "CO2", "O3", "N2O", "CO", "CH4", "O2+N2",
                       "TRACE", "TOTAL"]
        self.rtunits = {" Wavenumber": "", "H2O": "", "CO2": "", "O3": "",
                        "N2O": "", "CO": "",
    ...
    def RT_10_setup(self):
        self.rtkeys = ["WLINF", "WLSUP", "FFEW", "TOPDN", "TOPUP", "TOPDIR",
                       "BOTDN", "BOTUP", "BOTDIR", "TOPFLUX", "BOTFLUX",
                       "ABSORPTION"]
        self.rtunits = {" Intensity": True, " Transmitted": False,
                        "TOPDN": "$W/m^2$", "TOPUP": "$W/m^2$",
                        "TOPDIR": "$W/m^2$",
                        "BOTDN": "$W/m^2$", "BOTUP": "$W/m^2$",
                        "BOTDIR": "$W/m^2$",
                        "TOPFLUX": "$W/m^2$", "BOTFLUX": "$W/m^2$",
                        "ABSORPTION": "$W/m^2$"}
        self.intensity = True
    ...
    def RT_11_setup(self):
        self.rtkeys = ["FFEW", "ZZ", "PP", "FXDN", "FXUP", "FXDIR", "DFDZ",
                       "HEAT"]
        self.rtunits = {" Intensity": True, "FXDN": "$W/m^2$",
                        "FXUP": "$W/m^2$", "FXDIR": "$W/m^2$", "PP": "mb",
                        "DFDZ": "$mW/m^3$", "HEAT": "K/day"}
        self.intensity = False
        self.rtdefault = "FXDN"
    ...
    def RT_20_setup(self):
        self.rtkeys = ["WLINF", "WLSUP", "FFEW", "TOPDN", "TOPUP", "TOPDIR",
                       "BOTDN", "BOTUP", "BOTDIR", "TOPFLUX", "BOTFLUX",
                       "ABSORPTION", "RADIANCE"]
        self.rtunits = {" Intensity": True, "TOPDN": "$str^{-1}$",
                        "TOPUP": "$str^{-1}$", "TOPDIR": "$str^{-1}$",
                        "BOTDN": "$str^{-1}$", "BOTUP": "$str^{-1}$",
                        "BOTDIR": "$str^{-1}$", "TOPFLUX": "$str^{-1}$",
                        "BOTFLUX": "$str^{-1}$", "ABSORPTION": "$str^{-1}$",
                        "RADIANCE": "$W/m^2/str$"}
        self.intensity = True
